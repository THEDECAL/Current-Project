    ...
    public class TariffRegulator
    {
        ...
        private async Task CheckTariffStatehAsync(Profile profile)
        {
            if (profile != null && profile.Tariff != null)
            {
                ...
                if (profile.StartUsedOfTariff != null)
                {
                    expiryDate = profile.StartUsedOfTariff.Value
                ...
                if (expiryDate == null || //Если тариф ни разу не использовался
                    ...
                    profile.TrafficUsed >= profile.Tariff.AmountOfTraffic &&
                ...
                {
                    if (profile.BalanceOfCash < profile.Tariff.Price)
                    {
                    ...
                    {
                        profile.StartUsedOfTariff = currDate;
                        profile.BalanceOfCash -= profile.Tariff.Price;
